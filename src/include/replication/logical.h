...
typedef struct LogicalDecodingSlot
{
	 ...
	 * from to get a) a valid snapshot b) the complete content for all
	 * in-progress xacts
	 */
	...
	/*
	 * When the client has confirmed flushes >= candidate_xmin_after we can a)
	 * advance our xmin b) increase restart_decoding_from
	 *
	 */
